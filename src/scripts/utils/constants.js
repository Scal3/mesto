...
export const cardInputTypeTitle = document.querySelector('.popup__input_type_title')
export const cardInputTypeLink = document.querySelector('.popup__input_type_link')
